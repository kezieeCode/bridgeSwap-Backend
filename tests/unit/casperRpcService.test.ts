...
import { casperRpcService } from '../../src/services/casperRpcService';

const mockedFetch = fetch as unknown as jest.Mock;

describe('casperRpcService', () => {
  beforeEach(() => {
    mockedFetch.mockReset();
  });

  it('retrieves casper balance', async () => {
    ...
    const balance = await casperRpcService.getBalance('0x0000000000000000000000000000000000000000');
